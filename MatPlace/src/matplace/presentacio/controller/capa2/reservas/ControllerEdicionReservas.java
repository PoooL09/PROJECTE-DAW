...
import matplace.presentacio.controller.ControllerGestioReservas;
...
public class ControllerEdicionReservas extends Application implements Initializable {
    ...
    private void handleButtonEditar(ActionEvent event) {
        ...
        if (salaUtils.update(salaSeleccionada)) {
            ControllerMenuPrincipal.ventanaInformativa("Reserva editada con exito.");
        } else {
            ControllerMenuPrincipal.ventanaInformativa("No se ha podido editar la reserva.");
        }
    ...
    private void handleButtonBorrar(ActionEvent event) {
        ...
        new MaterialUtils().delete(ControllerGestioReservas.getReservaSeleccionada());
        ControllerMenuPrincipal.ventanaInformativa("Reserva eliminado con exito.");
    }
